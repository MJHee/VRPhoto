...
class MBMainViewController: MBScrollNavigationViewController {
    ...
    fileprivate lazy var tableView: UITableView = {
        ...
        // 注册
        table.register(MBPhotoCell.self, forCellReuseIdentifier: "Identifier")
...
extension MBMainViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "Identifier", for: indexPath) as! MBPhotoCell
...
extension MBMainViewController: UITableViewDelegate {
    
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        
        let filePath = Bundle.main.path(forResource: bundle + photos[indexPath.row], ofType: "jpg")!
        let photoVC = MBPhotoViewController(nibName: nil, bundle: nil, urlString: filePath)
...
// MARK: - MBPhotoCell
class MBPhotoCell: UITableViewCell {
...
//MARK: - MBScrollNavigationControllerDelegate
extension MBMainViewController: MBScrollNavigationControllerDelegate {
    
    func mbScrollNavigationController(_ controller: MBScrollNavigationController, didChangeState state: NavigationBarState) {
